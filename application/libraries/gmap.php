...
class Gmap {
	...
	*/
			    ...
			    if(html!=''){
			        ...
			        if(sidebar_id != ''){
						...
						if(sidebar!=null && sidebar!=undefined && title!=null && title!=''){
			        		...
			        		newlink.onclick=function(){if (infowindow) infowindow.close(); infowindow = new google.maps.InfoWindow({content: html}); infowindow.open(map,new_marker); map.panTo(point); map.setZoom(13); $('#sidebar_map li').removeClass('active'); newlink.className = 'active'; return false};
							":"
							newlink.onclick=function(){map.panTo(point); return false};
							")."
     ...
     */
    function getSidebar() {
        return sprintf('<ul id="%s" class="'.$this->sidebar_id.'"></ul>',$this->sidebar_id) . "\n";
    }    
