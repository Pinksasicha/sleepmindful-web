<section class="content-header">
  <h1><i class="fa fa-list-ul"></i> Score Question Maker</h1>
</section>

<form action="questionnaires/admin/score/save/<?php echo $question->id; ?>" method="post">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <div class="box-header" style="padding:20px 20px 0;">
            ...
            <button class="btn btn-default add-question" type="button">+ Question</button>
          </div>
  ...
  <div id="template-question">
    <div class="question">
      ...
      <div class="form-group">
        ...
        <input type="text" name="q[][title]" class="form-control">
        <input type="hidden" name="q[][type]" value="question">
      </div>
      <div class="answer">
        <div class="form-group">
          <div class="row">
  ...
  $(function() {
    ...
    q.map(function(json) {
      ...
      if (json.type == 'question') {
        ...
        var question = $('#template-question .question').clone();
    ...
    $('.add-question').click(function() {
      $('#template-question .question').clone().appendTo(".box-body");
    })
