<section class="content-header">
	<h1><i class="fa fa-file-text-o"></i> News</h1>
</section>

<form action="posts/admin/posts/save/<?php echo $post->id; ?>" method="POST" enctype="multipart/form-data">
				...
				<div class="box box-primary">
					<div class="box-body pad">
						<div class="form-group">
							...
							<img class="img-responsive" src="<?php echo $post->thumbnail_path(); ?>" style="height: 200px;">
							<?php endif; ?>
							<label>Thumbnail (460x460)</label>
							<input type="file" name="thumbnail">
						</div>
						<div class="form-group">
							<?php if ($post->banner_path()): ?>
							<img class="img-responsive" src="<?php echo $post->banner_path(); ?>" style="height: 200px;">
							<?php endif; ?>
						...
						<div class="form-group">
							<label>Title</label>
							<input type="text" name="title" placeholder="Name" class="form-control" value="<?php echo htmlentities($post->title);?>">
						</div>
						<div class="form-group">
							<label>Detail</label>
							<textarea name="detail" rows="10" class="form-control"><?php echo $post->detail; ?></textarea>
						</div>
					</div>
				</div>
			</div>
